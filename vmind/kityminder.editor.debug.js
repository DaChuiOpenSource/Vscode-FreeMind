/*!
 * ====================================================
 * kityminder-editor - v1.0.67 - 2022-04-16
...
(function () {
            ...
            switch (state) {
              ...
              case 'normal': {
                ...
                if (MimeType.whichMimeType(textData) === 'application/km') {
                  ...
                  var imageFile =
                    clipBoardEvent.clipboardData.items[0].getAsFile();
  ...
  angular.module('kityminderEditor').run([
    ...
    function ($templateCache) {
      ...
      $templateCache.put(
        'ui/directive/export/export.html',
        '<div class="km-btn-group export"><div class="km-btn-export"><div class="km-export-save" ng-click="save()"></div><span>Save</span></div><div class="km-btn-export"><div class="km-export-image" ng-click="exportToImage()"></div><span>ExportToImage</span></div></div>'
      );
      ...
      $templateCache.put(
        ...
        '<div class="style-operator"><a class="btn-wrap clear-style operatorbtn" ng-click="minder.queryCommandState(\'clearstyle\') === -1 || minder.execCommand(\'clearstyle\')" ng-disabled="minder.queryCommandState(\'clearstyle\') === -1"><span class="btn-icon clear-style-icon"></span> <span class="btn-label">{{ \'clearstyle\' | lang: \'ui\' }}</span></a> <a class="btn-wrap clear-style operatorbtn" href ng-click="minder.queryCommandState(\'copystyle\') === -1 || minder.execCommand(\'copystyle\')" ng-disabled="minder.queryCommandState(\'copystyle\') === -1"><span class="btn-icon copy-style-icon"></span> <span class="btn-label">{{ \'copystyle\' | lang: \'ui\' }}</span></a> <a class="btn-wrap clear-style operatorbtn" href ng-click="minder.queryCommandState(\'pastestyle\') === -1 || minder.execCommand(\'pastestyle\')" ng-disabled="minder.queryCommandState(\'pastestyle\') === -1"><span class="btn-icon paste-style-icon"></span> <span class="btn-label">{{ \'pastestyle\' | lang: \'ui\' }}</span></a></div>'
      );
      ...
      $templateCache.put(
        ...
        '<tabset><tab heading="{{ \'file\' | lang: \'ui/tabs\'; }}" ng-click="toggleTopTab(\'file\')" select="setCurTab(\'file\')"><export minder="minder"></export></tab><tab heading="{{ \'idea\' | lang: \'ui/tabs\'; }}" ng-click="toggleTopTab(\'idea\')" select="setCurTab(\'idea\')"><undo-redo editor="editor"></undo-redo><append-node minder="minder"></append-node><arrange minder="minder"></arrange><operation minder="minder"></operation><hyper-link minder="minder"></hyper-link><image-btn minder="minder"></image-btn><note-btn minder="minder"></note-btn><priority-editor minder="minder"></priority-editor><progress-editor minder="minder"></progress-editor><resource-editor minder="minder"></resource-editor></tab><tab heading="{{ \'appearence\' | lang: \'ui/tabs\'; }}" ng-click="toggleTopTab(\'appearance\')" select="setCurTab(\'appearance\')"><template-list minder="minder" class="inline-directive"></template-list><theme-list minder="minder"></theme-list><layout minder="minder" class="inline-directive"></layout><style-operator minder="minder" class="inline-directive"></style-operator><font-operator minder="minder" class="inline-directive"></font-operator></tab><tab heading="{{ \'view\' | lang: \'ui/tabs\'; }}" ng-click="toggleTopTab(\'view\')" select="setCurTab(\'view\')"><expand-level minder="minder"></expand-level><select-all minder="minder"></select-all><search-btn minder="minder"></search-btn></tab></tabset>'
      );
            ...
            resolve: {
              ...
              defaultValue: function () {
                var selectedNode = minder.getSelectedNode(),
                  Node2Text =
                    window.kityminder.data.getRegisterProtocol(
                      'text'
                    ).Node2Text;
  ...
  angular.module('kityminderEditor').filter('lang', [
    ...
    function (config, langcn, langen) {
      return function (text, block) {
        ...
        if (
          langcn[defaultLang] == undefined &&
          langen[defaultLang] == undefined
        ) {
          return '未发现对应语言包，请检查 lang.xxx.service.js!';
        } else {
          var dict;
          if (langen[defaultLang]) dict = langen[defaultLang];
          else dict = langcn[defaultLang];
  ...
  angular.module('kityminderEditor').directive('fontOperator', function () {
    return {
      ...
      link: function (scope) {
        ...
        scope.foreColor = scope.setDefaultColor() || '#000000';
  ...
  angular.module('kityminderEditor').directive('kityminderEditor', [
    ...
    'revokeDialog',
    'lang.en',
    function (config, minderService, revokeDialog, langen) {
      return {
        restrict: 'EA',
    ...
    function (memory, config) {
      return {
        ...
        link: function (scope) {
          ...
          scope.isNavOpen = true; //!memory.get('navigator-hidden');
    ...
    return {
      ...
      link: function (scope) {
        ...
        function closeTopTab() {
          ...
          /*// 因为在tab-content上使用了display-flex,此种隐藏方法失效,使用下面的方法
        $tabContent.animate({
          height: 0,
          display: 'none',
        });*/
